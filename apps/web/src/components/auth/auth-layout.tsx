...
export function AuthLayout({ children }: AuthLayoutProps) {
  return (
    <div className="h-app overflow-hidden bg-neutral-900 lg:flex lg:bg-background">
      <div className="relative h-[calc(var(--app-height)*0.3)] min-h-[200px] shrink-0 overflow-hidden lg:sticky lg:top-0 lg:h-app lg:w-1/2">
        <img
          alt=""
      ...
      <main className="safe-bottom relative z-10 -mt-7 h-[calc(var(--app-height)*0.7+1.75rem)] flex-1 overflow-y-auto rounded-t-[32px] bg-card px-6 pt-9 lg:mt-0 lg:flex lg:h-app lg:items-center lg:rounded-none lg:bg-background lg:px-10 lg:py-12">
